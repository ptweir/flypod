...
def plotIt(ax,flyToPlot,skyToPlot,changebuffer):
    ...
    ax.spines['bottom'].set_visible(False) #ax.spines['bottom'].set_position(('outward',8))
    ...
    #ax.set_yticklabels([u'0\u00b0','',u'180\u00b0','',u'360\u00b0'])
    ax.set_xticks([])#ax.set_xticks(np.arange(0,25,3))
